...
func (k Keeper) GetAllTypesByGroup(
	goCtx context.Context,
	req *types.QueryGetAllTypesByGroupRequest,
) (*types.QueryGetAllTypesByGroupResponse, error) {
	if req == nil {
	...
	pageRes, err := query.Paginate(
		typeStore, req.GetPagination(), func(key []byte, value []byte) error {
			...
			if ctype.GetGroup() == req.GetGroup() {
	...
	return &types.QueryGetAllTypesByGroupResponse{
		Ctype:      ctypes,
		Pagination: pageRes,
	}, nil
}
