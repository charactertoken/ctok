...
const baseCharacter = { tradeRestricted: false, saleTime: 0, creator: '', index: '', name: '', owner: '', ctype: '', cost: '', license: '' };
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.saleTime = longToNumber(reader.int64());
                    break;
                case 3:
