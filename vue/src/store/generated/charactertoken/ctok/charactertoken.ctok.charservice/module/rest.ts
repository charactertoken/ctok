...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryCharacterAll = (
    ...
    this.request<CharserviceQueryAllCharacterResponse, RpcStatus>({
      path: `/charactertoken/ctok/charservice/character`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryCharacter = (index: string, params: RequestParams = {}) =>
    this.request<CharserviceQueryGetCharacterResponse, RpcStatus>({
      path: `/charactertoken/ctok/charservice/character/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryGetAllCharsByCreator = (
    ...
    this.request<CharserviceQueryGetAllCharsByCreatorResponse, RpcStatus>({
      path: `/charactertoken/ctok/charservice/getAllCharsByCreator`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryGetAllCharsForSale = (
    ...
    this.request<CharserviceQueryGetAllCharsForSaleResponse, RpcStatus>({
      path: `/charactertoken/ctok/charservice/getAllCharsForSale`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryGetAllCharsOfOwner = (
    ...
    this.request<CharserviceQueryGetAllCharsOfOwnerResponse, RpcStatus>({
      path: `/charactertoken/ctok/charservice/getAllCharsOfOwner`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryGetAllCharsOfType = (
    ...
    this.request<CharserviceQueryGetAllCharsOfTypeResponse, RpcStatus>({
      path: `/charactertoken/ctok/charservice/getAllCharsOfType`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryGetCharByName = (query?: { name?: string }, params: RequestParams = {}) =>
    this.request<CharserviceQueryGetCharByNameResponse, RpcStatus>({
      path: `/charactertoken/ctok/charservice/getCharByName`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
